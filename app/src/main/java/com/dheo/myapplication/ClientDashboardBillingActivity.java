...
import com.dheo.myapplication.ModelClassLatestAccountActivity.M;
...
public class ClientDashboardBillingActivity extends AppCompatActivity {
    ...
    private List<com.dheo.myapplication.ModelClassClientPaymentReceiptPDF.M> pdf_receipt;
    private List<com.dheo.myapplication.ModelClassClientMonthlyStatementDate.M> monthly_billing_pdf;
