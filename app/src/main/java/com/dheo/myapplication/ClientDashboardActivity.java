...
import com.dheo.myapplication.modelClassPickupAddresses.M;
...
public class ClientDashboardActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    private List<com.dheo.myapplication.ModelClassClientDashboardPayloads.M> all_dashboard_payload;
    private List<com.dheo.myapplication.ModelClassAssingedCourierInfoDashboard.M> pickup_info_dashboard;
    private List<com.dheo.myapplication.ModelClassClientMonthlyStatementDate.M> monthly_payload_all_records;
    private List<com.dheo.myapplication.ModelClassClientPayloadSearch.M> payload_search;
    private List<com.dheo.myapplication.ModelClassPickupMapInfo.M> map_info;
