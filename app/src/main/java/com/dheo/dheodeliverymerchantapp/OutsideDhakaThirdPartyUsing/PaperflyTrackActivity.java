package com.dheo.dheodeliverymerchantapp.OutsideDhakaThirdPartyUsing;
...
import com.dheo.dheodeliverymerchantapp.ClientDashboardActivity;
import com.dheo.dheodeliverymerchantapp.ClientDashboardBillingActivity;
import com.dheo.dheodeliverymerchantapp.GraphActivity;
import com.dheo.dheodeliverymerchantapp.Helper;
import com.dheo.dheodeliverymerchantapp.LogInActivity;
import com.dheo.dheodeliverymerchantapp.ModelClassClientBasicInfo.ClientBasicInfo;
import com.dheo.dheodeliverymerchantapp.PickupEntryActivity;
import com.dheo.dheodeliverymerchantapp.R;
import com.dheo.dheodeliverymerchantapp.RetrofitClient;
import com.dheo.dheodeliverymerchantapp.SettingsActivity;
import com.dheo.dheodeliverymerchantapp.UserManualActivity;
...
public class PaperflyTrackActivity extends AppCompatActivity
{
    ...
    private String url;
    private TextView textViewOrderId,textViewPhoneNumber;

    @Override
    protected void onCreate(Bundle savedInstanceState)
    {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_paperfly_track);
        ...
        textViewPhoneNumber=findViewById(R.id.textViewOrderPhoneNumber);
        if (extras != null) {
            url = extras.getString("url");
            textViewOrderId.setText(extras.getString("orderId"));
            textViewPhoneNumber.setText(extras.getString("orderPhone"));
        }
        ...
        manualeItem.setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                ...
                Intent intent = new Intent(getApplicationContext(), PaperflyTrackActivity.class);
